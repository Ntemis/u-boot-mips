...
#define HAVE_tls_get_tp_si_mips16 ((HAVE_AS_TLS && TARGET_MIPS16) && (Pmode == SImode))
#define HAVE_tls_get_tp_di_mips16 ((HAVE_AS_TLS && TARGET_MIPS16) && (Pmode == DImode))
...
#define HAVE_mips_val_compare_and_swapd_acq ((GENERATE_LL_SC) && (TARGET_64BIT))
#define HAVE_mips_val_compare_and_swap_rel (GENERATE_LL_SC)
#define HAVE_mips_val_compare_and_swapd_rel ((GENERATE_LL_SC) && (TARGET_64BIT))
#define HAVE_mips_bool_compare_and_swap_acq (GENERATE_LL_SC)
#define HAVE_mips_bool_compare_and_swapd_acq ((GENERATE_LL_SC) && (TARGET_64BIT))
#define HAVE_mips_bool_compare_and_swap_rel (GENERATE_LL_SC)
#define HAVE_mips_bool_compare_and_swapd_rel ((GENERATE_LL_SC) && (TARGET_64BIT))
#define HAVE_compare_and_swap_12 (GENERATE_LL_SC)
#define HAVE_sync_add_ldaddsi (GENERATE_LDADD)
#define HAVE_sync_add_ldadddi ((GENERATE_LDADD) && (TARGET_64BIT))
#define HAVE_sync_add_ll_scsi (GENERATE_LL_SC && !GENERATE_LDADD)
#define HAVE_sync_add_ll_scdi ((GENERATE_LL_SC && !GENERATE_LDADD) && (TARGET_64BIT))
...
#define HAVE_sync_sub_ldadddi ((GENERATE_LDADD) && (TARGET_64BIT))
#define HAVE_sync_sub_ll_scsi (GENERATE_LL_SC && !GENERATE_LDADD)
#define HAVE_sync_sub_ll_scdi ((GENERATE_LL_SC && !GENERATE_LDADD) && (TARGET_64BIT))
#define HAVE_sync_old_add_ldaddsi (GENERATE_LDADD)
#define HAVE_sync_old_add_ldadddi ((GENERATE_LDADD) && (TARGET_64BIT))
#define HAVE_sync_old_add_ll_scsi (GENERATE_LL_SC && !GENERATE_LDADD)
#define HAVE_sync_old_add_ll_scdi ((GENERATE_LL_SC && !GENERATE_LDADD) && (TARGET_64BIT))
#define HAVE_sync_old_sub_ldaddsi (GENERATE_LDADD)
#define HAVE_sync_old_sub_ldadddi ((GENERATE_LDADD) && (TARGET_64BIT))
#define HAVE_sync_old_sub_ll_scsi (GENERATE_LL_SC && !GENERATE_LDADD)
#define HAVE_sync_old_sub_ll_scdi ((GENERATE_LL_SC && !GENERATE_LDADD) && (TARGET_64BIT))
#define HAVE_sync_new_add_ll_scsi (GENERATE_LL_SC && !GENERATE_LDADD)
#define HAVE_sync_new_add_ll_scdi ((GENERATE_LL_SC && !GENERATE_LDADD) && (TARGET_64BIT))
#define HAVE_sync_new_sub_ll_scsi (GENERATE_LL_SC)
#define HAVE_sync_new_sub_ll_scdi ((GENERATE_LL_SC) && (TARGET_64BIT))
...
#define HAVE_mips_swapd_ll_sc_acq ((GENERATE_LL_SC && !GENERATE_SWAP) && (TARGET_64BIT))
#define HAVE_mips_swap_ll_sc_rel (GENERATE_LL_SC && !GENERATE_SWAP)
#define HAVE_mips_swapd_ll_sc_rel ((GENERATE_LL_SC && !GENERATE_SWAP) && (TARGET_64BIT))
#define HAVE_mips_swap_acq (GENERATE_SWAP)
#define HAVE_mips_swapd_acq ((GENERATE_SWAP) && (TARGET_64BIT))
#define HAVE_mips_swap_rel (GENERATE_SWAP)
#define HAVE_mips_swapd_rel ((GENERATE_SWAP) && (TARGET_64BIT))
...
#define HAVE_sync_adddi ((GENERATE_LL_SC || GENERATE_LDADD) && (TARGET_64BIT))
...
#define HAVE_sync_subdi ((GENERATE_LL_SC || GENERATE_LDADD) && (TARGET_64BIT))
#define HAVE_sync_old_addsi (GENERATE_LL_SC || GENERATE_LDADD)
#define HAVE_sync_old_adddi ((GENERATE_LL_SC || GENERATE_LDADD) && (TARGET_64BIT))
#define HAVE_sync_old_subsi (GENERATE_LL_SC || GENERATE_LDADD)
#define HAVE_sync_old_subdi ((GENERATE_LL_SC || GENERATE_LDADD) && (TARGET_64BIT))
#define HAVE_sync_new_addsi (GENERATE_LL_SC || GENERATE_LDADD)
#define HAVE_sync_new_adddi ((GENERATE_LL_SC || GENERATE_LDADD) && (TARGET_64BIT))
#define HAVE_sync_new_subsi (GENERATE_LL_SC || GENERATE_LDADD)
#define HAVE_sync_new_subdi ((GENERATE_LL_SC || GENERATE_LDADD) && (TARGET_64BIT))
#define HAVE_sync_lock_test_and_setsi (GENERATE_LL_SC || GENERATE_SWAP)
#define HAVE_sync_lock_test_and_setdi ((GENERATE_LL_SC || GENERATE_SWAP) && (TARGET_64BIT))
...
extern rtx        gen_tls_get_tp_si_mips16            (rtx);
extern rtx        gen_tls_get_tp_di_mips16            (rtx);
...
extern rtx        gen_mips_val_compare_and_swapd_acq  (rtx, rtx, rtx, rtx);
extern rtx        gen_mips_val_compare_and_swap_rel   (rtx, rtx, rtx, rtx);
extern rtx        gen_mips_val_compare_and_swapd_rel  (rtx, rtx, rtx, rtx);
extern rtx        gen_mips_bool_compare_and_swap_acq  (rtx, rtx, rtx, rtx);
extern rtx        gen_mips_bool_compare_and_swapd_acq (rtx, rtx, rtx, rtx);
extern rtx        gen_mips_bool_compare_and_swap_rel  (rtx, rtx, rtx, rtx);
extern rtx        gen_mips_bool_compare_and_swapd_rel (rtx, rtx, rtx, rtx);
extern rtx        gen_compare_and_swap_12             (rtx, rtx, rtx, rtx, rtx, rtx);
extern rtx        gen_sync_add_ldaddsi                (rtx, rtx);
extern rtx        gen_sync_add_ldadddi                (rtx, rtx);
extern rtx        gen_sync_add_ll_scsi                (rtx, rtx);
extern rtx        gen_sync_add_ll_scdi                (rtx, rtx);
...
extern rtx        gen_sync_sub_ldadddi                (rtx, rtx);
extern rtx        gen_sync_sub_ll_scsi                (rtx, rtx);
extern rtx        gen_sync_sub_ll_scdi                (rtx, rtx);
extern rtx        gen_sync_old_add_ldaddsi            (rtx, rtx, rtx);
extern rtx        gen_sync_old_add_ldadddi            (rtx, rtx, rtx);
extern rtx        gen_sync_old_add_ll_scsi            (rtx, rtx, rtx);
extern rtx        gen_sync_old_add_ll_scdi            (rtx, rtx, rtx);
extern rtx        gen_sync_old_sub_ldaddsi            (rtx, rtx, rtx);
extern rtx        gen_sync_old_sub_ldadddi            (rtx, rtx, rtx);
extern rtx        gen_sync_old_sub_ll_scsi            (rtx, rtx, rtx);
extern rtx        gen_sync_old_sub_ll_scdi            (rtx, rtx, rtx);
extern rtx        gen_sync_new_add_ll_scsi            (rtx, rtx, rtx);
extern rtx        gen_sync_new_add_ll_scdi            (rtx, rtx, rtx);
extern rtx        gen_sync_new_sub_ll_scsi            (rtx, rtx, rtx);
extern rtx        gen_sync_new_sub_ll_scdi            (rtx, rtx, rtx);
...
extern rtx        gen_mips_swapd_ll_sc_acq            (rtx, rtx, rtx);
extern rtx        gen_mips_swap_ll_sc_rel             (rtx, rtx, rtx);
extern rtx        gen_mips_swapd_ll_sc_rel            (rtx, rtx, rtx);
extern rtx        gen_mips_swap_acq                   (rtx, rtx, rtx);
extern rtx        gen_mips_swapd_acq                  (rtx, rtx, rtx);
extern rtx        gen_mips_swap_rel                   (rtx, rtx, rtx);
extern rtx        gen_mips_swapd_rel                  (rtx, rtx, rtx);
