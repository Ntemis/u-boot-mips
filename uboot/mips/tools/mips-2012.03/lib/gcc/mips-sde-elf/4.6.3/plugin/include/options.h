...
enum opt_code
{
  ...
  OPT_Wpoison_system_directories = 298,      /* -Wpoison-system-directories */
  ...
  OPT_falign_arrays = 412,                   /* -falign-arrays */
  OPT_falign_commons = 413,                  /* -falign-commons */
  OPT_falign_functions = 414,                /* -falign-functions */
  OPT_falign_functions_ = 415,               /* -falign-functions= */
  OPT_falign_jumps = 416,                    /* -falign-jumps */
  OPT_falign_jumps_ = 417,                   /* -falign-jumps= */
  OPT_falign_labels = 418,                   /* -falign-labels */
  OPT_falign_labels_ = 419,                  /* -falign-labels= */
  OPT_falign_loops = 420,                    /* -falign-loops */
  OPT_falign_loops_ = 421,                   /* -falign-loops= */
  OPT_fall_intrinsics = 422,                 /* -fall-intrinsics */
  /* OPT_fall_virtual = 423, */              /* -fall-virtual */
  OPT_fallow_leading_underscore = 424,       /* -fallow-leading-underscore */
  /* OPT_falt_external_templates = 425, */   /* -falt-external-templates */
  /* OPT_fargument_alias = 426, */           /* -fargument-alias */
  /* OPT_fargument_noalias = 427, */         /* -fargument-noalias */
  /* OPT_fargument_noalias_anything = 428, *//* -fargument-noalias-anything */
  /* OPT_fargument_noalias_global = 429, */  /* -fargument-noalias-global */
  OPT_fasm = 430,                            /* -fasm */
  OPT_fassert = 431,                         /* -fassert */
  OPT_fassociative_math = 432,               /* -fassociative-math */
  OPT_fassume_compiled = 433,                /* -fassume-compiled */
  OPT_fassume_compiled_ = 434,               /* -fassume-compiled= */
  OPT_fasynchronous_unwind_tables = 435,     /* -fasynchronous-unwind-tables */
  OPT_fauto_inc_dec = 436,                   /* -fauto-inc-dec */
  OPT_fautomatic = 437,                      /* -fautomatic */
  OPT_faux_classpath = 438,                  /* -faux-classpath */
  OPT_fbackslash = 439,                      /* -fbackslash */
  OPT_fbacktrace = 440,                      /* -fbacktrace */
  OPT_fblas_matmul_limit_ = 441,             /* -fblas-matmul-limit= */
  OPT_fbootclasspath_ = 442,                 /* -fbootclasspath= */
  OPT_fbootstrap_classes = 443,              /* -fbootstrap-classes */
  OPT_fbounds_check = 444,                   /* -fbounds-check */
  OPT_fbranch_count_reg = 445,               /* -fbranch-count-reg */
  OPT_fbranch_probabilities = 446,           /* -fbranch-probabilities */
  OPT_fbranch_target_load_optimize = 447,    /* -fbranch-target-load-optimize */
  OPT_fbranch_target_load_optimize2 = 448,   /* -fbranch-target-load-optimize2 */
  OPT_fbtr_bb_exclusive = 449,               /* -fbtr-bb-exclusive */
  OPT_fbuiltin = 450,                        /* -fbuiltin */
  OPT_fbuiltin_ = 451,                       /* -fbuiltin- */
  OPT_fcall_saved_ = 452,                    /* -fcall-saved- */
  OPT_fcall_used_ = 453,                     /* -fcall-used- */
  OPT_fcaller_saves = 454,                   /* -fcaller-saves */
  OPT_fcheck_array_temporaries = 455,        /* -fcheck-array-temporaries */
  OPT_fcheck_data_deps = 456,                /* -fcheck-data-deps */
  OPT_fcheck_new = 457,                      /* -fcheck-new */
  OPT_fcheck_references = 458,               /* -fcheck-references */
  OPT_fcheck_ = 459,                         /* -fcheck= */
  OPT_fclasspath_ = 460,                     /* -fclasspath= */
  OPT_fcoarray_ = 461,                       /* -fcoarray= */
  OPT_fcombine_stack_adjustments = 462,      /* -fcombine-stack-adjustments */
  OPT_fcommon = 463,                         /* -fcommon */
  OPT_fcompare_debug = 464,                  /* -fcompare-debug */
  OPT_fcompare_debug_second = 465,           /* -fcompare-debug-second */
  OPT_fcompare_debug_ = 466,                 /* -fcompare-debug= */
  OPT_fcompare_elim = 467,                   /* -fcompare-elim */
  OPT_fcompile_resource_ = 468,              /* -fcompile-resource= */
  OPT_fcond_mismatch = 469,                  /* -fcond-mismatch */
  OPT_fconserve_space = 470,                 /* -fconserve-space */
  OPT_fconserve_stack = 471,                 /* -fconserve-stack */
  OPT_fconstant_string_class_ = 472,         /* -fconstant-string-class= */
  OPT_fconstexpr_depth_ = 473,               /* -fconstexpr-depth= */
  OPT_fconvert_big_endian = 474,             /* -fconvert=big-endian */
  OPT_fconvert_little_endian = 475,          /* -fconvert=little-endian */
  OPT_fconvert_native = 476,                 /* -fconvert=native */
  OPT_fconvert_swap = 477,                   /* -fconvert=swap */
  OPT_fcprop_registers = 478,                /* -fcprop-registers */
  OPT_fcray_pointer = 479,                   /* -fcray-pointer */
  OPT_fcrossjumping = 480,                   /* -fcrossjumping */
  OPT_fcse_follow_jumps = 481,               /* -fcse-follow-jumps */
  /* OPT_fcse_skip_blocks = 482, */          /* -fcse-skip-blocks */
  OPT_fcx_fortran_rules = 483,               /* -fcx-fortran-rules */
  OPT_fcx_limited_range = 484,               /* -fcx-limited-range */
  OPT_fd_lines_as_code = 485,                /* -fd-lines-as-code */
  OPT_fd_lines_as_comments = 486,            /* -fd-lines-as-comments */
  OPT_fdata_sections = 487,                  /* -fdata-sections */
  OPT_fdbg_cnt_list = 488,                   /* -fdbg-cnt-list */
  OPT_fdbg_cnt_ = 489,                       /* -fdbg-cnt= */
  OPT_fdce = 490,                            /* -fdce */
  OPT_fdebug_prefix_map_ = 491,              /* -fdebug-prefix-map= */
  OPT_fdeduce_init_list = 492,               /* -fdeduce-init-list */
  OPT_fdefault_double_8 = 493,               /* -fdefault-double-8 */
  /* OPT_fdefault_inline = 494, */           /* -fdefault-inline */
  OPT_fdefault_integer_8 = 495,              /* -fdefault-integer-8 */
  OPT_fdefault_real_8 = 496,                 /* -fdefault-real-8 */
  OPT_fdefer_pop = 497,                      /* -fdefer-pop */
  OPT_fdelayed_branch = 498,                 /* -fdelayed-branch */
  ...
  OPT_feglibc_ = 522,                        /* -feglibc= */
  OPT_felide_constructors = 523,             /* -felide-constructors */
  OPT_feliminate_dwarf2_dups = 524,          /* -feliminate-dwarf2-dups */
  OPT_feliminate_unused_debug_symbols = 525, /* -feliminate-unused-debug-symbols */
  OPT_feliminate_unused_debug_types = 526,   /* -feliminate-unused-debug-types */
  OPT_femit_class_debug_always = 527,        /* -femit-class-debug-always */
  OPT_femit_class_file = 528,                /* -femit-class-file */
  OPT_femit_class_files = 529,               /* -femit-class-files */
  OPT_femit_struct_debug_baseonly = 530,     /* -femit-struct-debug-baseonly */
  OPT_femit_struct_debug_detailed_ = 531,    /* -femit-struct-debug-detailed= */
  OPT_femit_struct_debug_reduced = 532,      /* -femit-struct-debug-reduced */
  OPT_fenable_assertions = 533,              /* -fenable-assertions */
  OPT_fenable_assertions_ = 534,             /* -fenable-assertions= */
  OPT_fenable_icf_debug = 535,               /* -fenable-icf-debug */
  OPT_fencoding_ = 536,                      /* -fencoding= */
  OPT_fenforce_eh_specs = 537,               /* -fenforce-eh-specs */
  /* OPT_fenum_int_equiv = 538, */           /* -fenum-int-equiv */
  OPT_fexceptions = 539,                     /* -fexceptions */
  OPT_fexcess_precision_ = 540,              /* -fexcess-precision= */
  OPT_fexec_charset_ = 541,                  /* -fexec-charset= */
  OPT_fexpensive_optimizations = 542,        /* -fexpensive-optimizations */
  OPT_fextdirs_ = 543,                       /* -fextdirs= */
  OPT_fextended_identifiers = 544,           /* -fextended-identifiers */
  OPT_fextension_elimination = 545,          /* -fextension-elimination */
  OPT_fexternal_blas = 546,                  /* -fexternal-blas */
  /* OPT_fexternal_templates = 547, */       /* -fexternal-templates */
  OPT_ff2c = 548,                            /* -ff2c */
  OPT_ffast_math = 549,                      /* -ffast-math */
  OPT_ffeature_proxy = 550,                  /* -ffeature-proxy */
  OPT_ffilelist_file = 551,                  /* -ffilelist-file */
  OPT_ffinite_math_only = 552,               /* -ffinite-math-only */
  ...
  OPT_fforward_propagate = 561,              /* -fforward-propagate */
  OPT_ffp_contract_ = 562,                   /* -ffp-contract= */
  OPT_ffpe_trap_ = 563,                      /* -ffpe-trap= */
  OPT_ffree_form = 564,                      /* -ffree-form */
  OPT_ffree_line_length_ = 565,              /* -ffree-line-length- */
  OPT_ffree_line_length_none = 566,          /* -ffree-line-length-none */
  OPT_ffreestanding = 567,                   /* -ffreestanding */
  OPT_ffriend_injection = 568,               /* -ffriend-injection */
  OPT_ffunction_cse = 569,                   /* -ffunction-cse */
  OPT_ffunction_sections = 570,              /* -ffunction-sections */
  OPT_fgcse = 571,                           /* -fgcse */
  OPT_fgcse_after_reload = 572,              /* -fgcse-after-reload */
  OPT_fgcse_las = 573,                       /* -fgcse-las */
  OPT_fgcse_lm = 574,                        /* -fgcse-lm */
  OPT_fgcse_sm = 575,                        /* -fgcse-sm */
  OPT_fgnu_keywords = 576,                   /* -fgnu-keywords */
  OPT_fgnu_runtime = 577,                    /* -fgnu-runtime */
  OPT_fgnu89_inline = 578,                   /* -fgnu89-inline */
  OPT_fgo_dump_ = 579,                       /* -fgo-dump- */
  OPT_fgo_prefix_ = 580,                     /* -fgo-prefix= */
  OPT_fgraphite = 581,                       /* -fgraphite */
  OPT_fgraphite_identity = 582,              /* -fgraphite-identity */
  OPT_fguess_branch_probability = 583,       /* -fguess-branch-probability */
  /* OPT_fguiding_decls = 584, */            /* -fguiding-decls */
  /* OPT_fhandle_exceptions = 585, */        /* -fhandle-exceptions */
  OPT_fhash_synchronization = 586,           /* -fhash-synchronization */
  /* OPT_fhelp = 587, */                     /* -fhelp */
  /* OPT_fhelp_ = 588, */                    /* -fhelp= */
  /* OPT_fhonor_std = 589, */                /* -fhonor-std */
  OPT_fhosted = 590,                         /* -fhosted */
  /* OPT_fhuge_objects = 591, */             /* -fhuge-objects */
  OPT_fident = 592,                          /* -fident */
  OPT_fif_conversion = 593,                  /* -fif-conversion */
  OPT_fif_conversion2 = 594,                 /* -fif-conversion2 */
  OPT_fimplement_inlines = 595,              /* -fimplement-inlines */
  OPT_fimplicit_inline_templates = 596,      /* -fimplicit-inline-templates */
  OPT_fimplicit_none = 597,                  /* -fimplicit-none */
  OPT_fimplicit_templates = 598,             /* -fimplicit-templates */
  OPT_findirect_classes = 599,               /* -findirect-classes */
  OPT_findirect_dispatch = 600,              /* -findirect-dispatch */
  OPT_findirect_inlining = 601,              /* -findirect-inlining */
  OPT_finhibit_size_directive = 602,         /* -finhibit-size-directive */
  OPT_finit_character_ = 603,                /* -finit-character= */
  OPT_finit_integer_ = 604,                  /* -finit-integer= */
  OPT_finit_local_zero = 605,                /* -finit-local-zero */
  OPT_finit_logical_ = 606,                  /* -finit-logical= */
  OPT_finit_real_ = 607,                     /* -finit-real= */
  OPT_finline = 608,                         /* -finline */
  OPT_finline_functions = 609,               /* -finline-functions */
  OPT_finline_functions_called_once = 610,   /* -finline-functions-called-once */
  /* OPT_finline_limit_ = 611, */            /* -finline-limit- */
  OPT_finline_limit_ = 612,                  /* -finline-limit= */
  OPT_finline_small_functions = 613,         /* -finline-small-functions */
  OPT_finput_charset_ = 614,                 /* -finput-charset= */
  OPT_finstrument_function_calls = 615,      /* -finstrument-function-calls */
  ...
  OPT_flicense_me = 644,                     /* -flicense-me */
  OPT_floop_block = 645,                     /* -floop-block */
  OPT_floop_flatten = 646,                   /* -floop-flatten */
  OPT_floop_interchange = 647,               /* -floop-interchange */
  /* OPT_floop_optimize = 648, */            /* -floop-optimize */
  OPT_floop_parallelize_all = 649,           /* -floop-parallelize-all */
  OPT_floop_strip_mine = 650,                /* -floop-strip-mine */
  OPT_flto = 651,                            /* -flto */
  OPT_flto_compression_level_ = 652,         /* -flto-compression-level= */
  OPT_flto_partition_1to1 = 653,             /* -flto-partition=1to1 */
  OPT_flto_partition_balanced = 654,         /* -flto-partition=balanced */
  OPT_flto_partition_none = 655,             /* -flto-partition=none */
  OPT_flto_report = 656,                     /* -flto-report */
  OPT_flto_ = 657,                           /* -flto= */
  OPT_fltrans = 658,                         /* -fltrans */
  OPT_fltrans_output_list_ = 659,            /* -fltrans-output-list= */
  OPT_fmain_ = 660,                          /* -fmain= */
  OPT_fmath_errno = 661,                     /* -fmath-errno */
  OPT_fmax_array_constructor_ = 662,         /* -fmax-array-constructor= */
  OPT_fmax_errors_ = 663,                    /* -fmax-errors= */
  OPT_fmax_identifier_length_ = 664,         /* -fmax-identifier-length= */
  OPT_fmax_stack_var_size_ = 665,            /* -fmax-stack-var-size= */
  OPT_fmax_subrecord_length_ = 666,          /* -fmax-subrecord-length= */
  OPT_fmem_report = 667,                     /* -fmem-report */
  OPT_fmerge_all_constants = 668,            /* -fmerge-all-constants */
  OPT_fmerge_constants = 669,                /* -fmerge-constants */
  OPT_fmerge_debug_strings = 670,            /* -fmerge-debug-strings */
  OPT_fmessage_length_ = 671,                /* -fmessage-length= */
  OPT_fmodule_private = 672,                 /* -fmodule-private */
  OPT_fmodulo_sched = 673,                   /* -fmodulo-sched */
  OPT_fmodulo_sched_allow_regmoves = 674,    /* -fmodulo-sched-allow-regmoves */
  OPT_fmove_loop_invariants = 675,           /* -fmove-loop-invariants */
  OPT_fms_extensions = 676,                  /* -fms-extensions */
  OPT_fmudflap = 677,                        /* -fmudflap */
  OPT_fmudflapir = 678,                      /* -fmudflapir */
  OPT_fmudflapth = 679,                      /* -fmudflapth */
  /* OPT_fname_mangling_version_ = 680, */   /* -fname-mangling-version- */
  /* OPT_fnew_abi = 681, */                  /* -fnew-abi */
  OPT_fnext_runtime = 682,                   /* -fnext-runtime */
  OPT_fnil_receivers = 683,                  /* -fnil-receivers */
  OPT_fnon_call_exceptions = 684,            /* -fnon-call-exceptions */
  OPT_fnonansi_builtins = 685,               /* -fnonansi-builtins */
  /* OPT_fnonnull_objects = 686, */          /* -fnonnull-objects */
  OPT_fnothrow_opt = 687,                    /* -fnothrow-opt */
  OPT_fobjc_abi_version_ = 688,              /* -fobjc-abi-version= */
  OPT_fobjc_call_cxx_cdtors = 689,           /* -fobjc-call-cxx-cdtors */
  OPT_fobjc_direct_dispatch = 690,           /* -fobjc-direct-dispatch */
  OPT_fobjc_exceptions = 691,                /* -fobjc-exceptions */
  OPT_fobjc_gc = 692,                        /* -fobjc-gc */
  OPT_fobjc_nilcheck = 693,                  /* -fobjc-nilcheck */
  OPT_fobjc_sjlj_exceptions = 694,           /* -fobjc-sjlj-exceptions */
  OPT_fobjc_std_objc1 = 695,                 /* -fobjc-std=objc1 */
  OPT_fomit_frame_pointer = 696,             /* -fomit-frame-pointer */
  OPT_fopenmp = 697,                         /* -fopenmp */
  OPT_foperator_names = 698,                 /* -foperator-names */
  OPT_foptimize_register_move = 699,         /* -foptimize-register-move */
  OPT_foptimize_sibling_calls = 700,         /* -foptimize-sibling-calls */
  OPT_foptimize_static_class_initialization = 701,/* -foptimize-static-class-initialization */
  /* OPT_foptional_diags = 702, */           /* -foptional-diags */
  OPT_foutput_class_dir_ = 703,              /* -foutput-class-dir= */
  OPT_fpack_derived = 704,                   /* -fpack-derived */
  OPT_fpack_struct = 705,                    /* -fpack-struct */
  OPT_fpack_struct_ = 706,                   /* -fpack-struct= */
  OPT_fpartial_inlining = 707,               /* -fpartial-inlining */
  OPT_fpcc_struct_return = 708,              /* -fpcc-struct-return */
  OPT_fpch_deps = 709,                       /* -fpch-deps */
  OPT_fpch_preprocess = 710,                 /* -fpch-preprocess */
  OPT_fpeel_loops = 711,                     /* -fpeel-loops */
  OPT_fpeephole = 712,                       /* -fpeephole */
  OPT_fpeephole2 = 713,                      /* -fpeephole2 */
  OPT_fpermissive = 714,                     /* -fpermissive */
  OPT_fpic = 715,                            /* -fpic */
  OPT_fpie = 716,                            /* -fpie */
  OPT_fplan9_extensions = 717,               /* -fplan9-extensions */
  OPT_fplugin_arg_ = 718,                    /* -fplugin-arg- */
  OPT_fplugin_ = 719,                        /* -fplugin= */
  OPT_fpost_ipa_mem_report = 720,            /* -fpost-ipa-mem-report */
  OPT_fpre_ipa_mem_report = 721,             /* -fpre-ipa-mem-report */
  OPT_fpredictive_commoning = 722,           /* -fpredictive-commoning */
  OPT_fprefetch_loop_arrays = 723,           /* -fprefetch-loop-arrays */
  OPT_fpreprocessed = 724,                   /* -fpreprocessed */
  OPT_fpretty_templates = 725,               /* -fpretty-templates */
  OPT_fprofile = 726,                        /* -fprofile */
  OPT_fprofile_arcs = 727,                   /* -fprofile-arcs */
  OPT_fprofile_correction = 728,             /* -fprofile-correction */
  OPT_fprofile_dir_ = 729,                   /* -fprofile-dir= */
  OPT_fprofile_generate = 730,               /* -fprofile-generate */
  OPT_fprofile_generate_ = 731,              /* -fprofile-generate= */
  OPT_fprofile_use = 732,                    /* -fprofile-use */
  OPT_fprofile_use_ = 733,                   /* -fprofile-use= */
  OPT_fprofile_values = 734,                 /* -fprofile-values */
  OPT_fpromote_loop_indices = 735,           /* -fpromote-loop-indices */
  OPT_fprotect_parens = 736,                 /* -fprotect-parens */
  OPT_frandom_seed = 737,                    /* -frandom-seed */
  OPT_frandom_seed_ = 738,                   /* -frandom-seed= */
  OPT_frange_check = 739,                    /* -frange-check */
  OPT_frealloc_lhs = 740,                    /* -frealloc-lhs */
  OPT_freciprocal_math = 741,                /* -freciprocal-math */
  OPT_frecord_gcc_switches = 742,            /* -frecord-gcc-switches */
  OPT_frecord_marker_4 = 743,                /* -frecord-marker=4 */
  OPT_frecord_marker_8 = 744,                /* -frecord-marker=8 */
  OPT_frecursive = 745,                      /* -frecursive */
  OPT_freduced_reflection = 746,             /* -freduced-reflection */
  OPT_freg_struct_return = 747,              /* -freg-struct-return */
  OPT_fregmove = 748,                        /* -fregmove */
  OPT_fremove_local_statics = 749,           /* -fremove-local-statics */
  OPT_frename_registers = 750,               /* -frename-registers */
  OPT_freorder_blocks = 751,                 /* -freorder-blocks */
  OPT_freorder_blocks_and_partition = 752,   /* -freorder-blocks-and-partition */
  OPT_freorder_functions = 753,              /* -freorder-functions */
  OPT_frepack_arrays = 754,                  /* -frepack-arrays */
  OPT_freplace_objc_classes = 755,           /* -freplace-objc-classes */
  OPT_frepo = 756,                           /* -frepo */
  OPT_frequire_return_statement = 757,       /* -frequire-return-statement */
  OPT_frerun_cse_after_loop = 758,           /* -frerun-cse-after-loop */
  /* OPT_frerun_loop_opt = 759, */           /* -frerun-loop-opt */
  OPT_freschedule_modulo_scheduled_loops = 760,/* -freschedule-modulo-scheduled-loops */
  OPT_fresolution_ = 761,                    /* -fresolution= */
  OPT_frounding_math = 762,                  /* -frounding-math */
  OPT_frtti = 763,                           /* -frtti */
  OPT_fsaw_java_file = 764,                  /* -fsaw-java-file */
  OPT_fsched_critical_path_heuristic = 765,  /* -fsched-critical-path-heuristic */
  OPT_fsched_dep_count_heuristic = 766,      /* -fsched-dep-count-heuristic */
  OPT_fsched_group_heuristic = 767,          /* -fsched-group-heuristic */
  OPT_fsched_interblock = 768,               /* -fsched-interblock */
  OPT_fsched_last_insn_heuristic = 769,      /* -fsched-last-insn-heuristic */
  OPT_fsched_pressure = 770,                 /* -fsched-pressure */
  OPT_fsched_rank_heuristic = 771,           /* -fsched-rank-heuristic */
  OPT_fsched_spec = 772,                     /* -fsched-spec */
  OPT_fsched_spec_insn_heuristic = 773,      /* -fsched-spec-insn-heuristic */
  OPT_fsched_spec_load = 774,                /* -fsched-spec-load */
  OPT_fsched_spec_load_dangerous = 775,      /* -fsched-spec-load-dangerous */
  OPT_fsched_stalled_insns = 776,            /* -fsched-stalled-insns */
  OPT_fsched_stalled_insns_dep = 777,        /* -fsched-stalled-insns-dep */
  OPT_fsched_stalled_insns_dep_ = 778,       /* -fsched-stalled-insns-dep= */
  OPT_fsched_stalled_insns_ = 779,           /* -fsched-stalled-insns= */
  OPT_fsched_verbose_ = 780,                 /* -fsched-verbose= */
  OPT_fsched2_use_superblocks = 781,         /* -fsched2-use-superblocks */
  /* OPT_fsched2_use_traces = 782, */        /* -fsched2-use-traces */
  OPT_fschedule_insns = 783,                 /* -fschedule-insns */
  OPT_fschedule_insns2 = 784,                /* -fschedule-insns2 */
  OPT_fsecond_underscore = 785,              /* -fsecond-underscore */
  OPT_fsection_anchors = 786,                /* -fsection-anchors */
  /* OPT_fsee = 787, */                      /* -fsee */
  OPT_fsel_sched_pipelining = 788,           /* -fsel-sched-pipelining */
  OPT_fsel_sched_pipelining_outer_loops = 789,/* -fsel-sched-pipelining-outer-loops */
  OPT_fsel_sched_reschedule_pipelined = 790, /* -fsel-sched-reschedule-pipelined */
  OPT_fselective_scheduling = 791,           /* -fselective-scheduling */
  OPT_fselective_scheduling2 = 792,          /* -fselective-scheduling2 */
  OPT_fshort_double = 793,                   /* -fshort-double */
  OPT_fshort_enums = 794,                    /* -fshort-enums */
  OPT_fshort_wchar = 795,                    /* -fshort-wchar */
  OPT_fshow_column = 796,                    /* -fshow-column */
  OPT_fshrink_wrap = 797,                    /* -fshrink-wrap */
  OPT_fsign_zero = 798,                      /* -fsign-zero */
  OPT_fsignaling_nans = 799,                 /* -fsignaling-nans */
  OPT_fsigned_bitfields = 800,               /* -fsigned-bitfields */
  OPT_fsigned_char = 801,                    /* -fsigned-char */
  OPT_fsigned_zeros = 802,                   /* -fsigned-zeros */
  OPT_fsingle_precision_constant = 803,      /* -fsingle-precision-constant */
  OPT_fsource_filename_ = 804,               /* -fsource-filename= */
  OPT_fsource_ = 805,                        /* -fsource= */
  OPT_fsplit_ivs_in_unroller = 806,          /* -fsplit-ivs-in-unroller */
  OPT_fsplit_stack = 807,                    /* -fsplit-stack */
  OPT_fsplit_wide_types = 808,               /* -fsplit-wide-types */
  /* OPT_fsquangle = 809, */                 /* -fsquangle */
  /* OPT_fstack_check = 810, */              /* -fstack-check */
  OPT_fstack_check_ = 811,                   /* -fstack-check= */
  OPT_fstack_limit = 812,                    /* -fstack-limit */
  OPT_fstack_limit_register_ = 813,          /* -fstack-limit-register= */
  OPT_fstack_limit_symbol_ = 814,            /* -fstack-limit-symbol= */
  OPT_fstack_protector = 815,                /* -fstack-protector */
  OPT_fstack_protector_all = 816,            /* -fstack-protector-all */
  OPT_fstack_usage = 817,                    /* -fstack-usage */
  OPT_fstats = 818,                          /* -fstats */
  OPT_fstore_check = 819,                    /* -fstore-check */
  /* OPT_fstrength_reduce = 820, */          /* -fstrength-reduce */
  OPT_fstrict_aliasing = 821,                /* -fstrict-aliasing */
  OPT_fstrict_enums = 822,                   /* -fstrict-enums */
  OPT_fstrict_overflow = 823,                /* -fstrict-overflow */
  /* OPT_fstrict_prototype = 824, */         /* -fstrict-prototype */
  OPT_fstrict_volatile_bitfields = 825,      /* -fstrict-volatile-bitfields */
  OPT_fsyntax_only = 826,                    /* -fsyntax-only */
  OPT_ftabstop_ = 827,                       /* -ftabstop= */
  /* OPT_ftarget_help = 828, */              /* -ftarget-help */
  OPT_ftarget_ = 829,                        /* -ftarget= */
  /* OPT_ftemplate_depth_ = 830, */          /* -ftemplate-depth- */
  OPT_ftemplate_depth_ = 831,                /* -ftemplate-depth= */
  OPT_ftest_coverage = 832,                  /* -ftest-coverage */
  /* OPT_fthis_is_variable = 833, */         /* -fthis-is-variable */
  OPT_fthread_jumps = 834,                   /* -fthread-jumps */
  OPT_fthreadsafe_statics = 835,             /* -fthreadsafe-statics */
  OPT_ftime_report = 836,                    /* -ftime-report */
  OPT_ftls_model_ = 837,                     /* -ftls-model= */
  OPT_ftoplevel_reorder = 838,               /* -ftoplevel-reorder */
  OPT_ftracer = 839,                         /* -ftracer */
  OPT_ftrapping_math = 840,                  /* -ftrapping-math */
  OPT_ftrapv = 841,                          /* -ftrapv */
  OPT_ftree_bit_ccp = 842,                   /* -ftree-bit-ccp */
  OPT_ftree_builtin_call_dce = 843,          /* -ftree-builtin-call-dce */
  OPT_ftree_ccp = 844,                       /* -ftree-ccp */
  OPT_ftree_ch = 845,                        /* -ftree-ch */
  ...
  OPT_ftree_if_to_switch_conversion = 854,   /* -ftree-if-to-switch-conversion */
  OPT_ftree_loop_distribute_patterns = 855,  /* -ftree-loop-distribute-patterns */
  OPT_ftree_loop_distribution = 856,         /* -ftree-loop-distribution */
  OPT_ftree_loop_if_convert = 857,           /* -ftree-loop-if-convert */
  OPT_ftree_loop_if_convert_stores = 858,    /* -ftree-loop-if-convert-stores */
  OPT_ftree_loop_im = 859,                   /* -ftree-loop-im */
  OPT_ftree_loop_ivcanon = 860,              /* -ftree-loop-ivcanon */
  /* OPT_ftree_loop_linear = 861, */         /* -ftree-loop-linear */
  OPT_ftree_loop_optimize = 862,             /* -ftree-loop-optimize */
  OPT_ftree_lrs = 863,                       /* -ftree-lrs */
  OPT_ftree_parallelize_loops_ = 864,        /* -ftree-parallelize-loops= */
  OPT_ftree_phiprop = 865,                   /* -ftree-phiprop */
  OPT_ftree_pre = 866,                       /* -ftree-pre */
  OPT_ftree_pre_partial_partial = 867,       /* -ftree-pre-partial-partial */
  OPT_ftree_pre_partial_partial_obliviously = 868,/* -ftree-pre-partial-partial-obliviously */
  OPT_ftree_pta = 869,                       /* -ftree-pta */
  OPT_ftree_reassoc = 870,                   /* -ftree-reassoc */
  /* OPT_ftree_salias = 871, */              /* -ftree-salias */
  OPT_ftree_scev_cprop = 872,                /* -ftree-scev-cprop */
  OPT_ftree_sink = 873,                      /* -ftree-sink */
  OPT_ftree_slp_vectorize = 874,             /* -ftree-slp-vectorize */
  ...
  OPT_ftree_ter = 879,                       /* -ftree-ter */
  OPT_ftree_vect_loop_version = 880,         /* -ftree-vect-loop-version */
  OPT_ftree_vectorize = 881,                 /* -ftree-vectorize */
  OPT_ftree_vectorizer_verbose_ = 882,       /* -ftree-vectorizer-verbose= */
  OPT_ftree_vrp = 883,                       /* -ftree-vrp */
  OPT_funderscoring = 884,                   /* -funderscoring */
  OPT_funit_at_a_time = 885,                 /* -funit-at-a-time */
  OPT_funroll_all_loops = 886,               /* -funroll-all-loops */
  OPT_funroll_loops = 887,                   /* -funroll-loops */
  OPT_funsafe_loop_optimizations = 888,      /* -funsafe-loop-optimizations */
  OPT_funsafe_math_optimizations = 889,      /* -funsafe-math-optimizations */
  OPT_funsigned_bitfields = 890,             /* -funsigned-bitfields */
  OPT_funsigned_char = 891,                  /* -funsigned-char */
  OPT_funswitch_loops = 892,                 /* -funswitch-loops */
  OPT_funwind_tables = 893,                  /* -funwind-tables */
  OPT_fuse_atomic_builtins = 894,            /* -fuse-atomic-builtins */
  OPT_fuse_boehm_gc = 895,                   /* -fuse-boehm-gc */
  OPT_fuse_caller_save = 896,                /* -fuse-caller-save */
  OPT_fuse_cxa_atexit = 897,                 /* -fuse-cxa-atexit */
  OPT_fuse_cxa_get_exception_ptr = 898,      /* -fuse-cxa-get-exception-ptr */
  OPT_fuse_divide_subroutine = 899,          /* -fuse-divide-subroutine */
  OPT_fuse_linker_plugin = 900,              /* -fuse-linker-plugin */
  OPT_fvar_tracking = 901,                   /* -fvar-tracking */
  OPT_fvar_tracking_assignments = 902,       /* -fvar-tracking-assignments */
  OPT_fvar_tracking_assignments_toggle = 903,/* -fvar-tracking-assignments-toggle */
  OPT_fvar_tracking_uninit = 904,            /* -fvar-tracking-uninit */
  OPT_fvariable_expansion_in_unroller = 905, /* -fvariable-expansion-in-unroller */
  OPT_fvect_cost_model = 906,                /* -fvect-cost-model */
  ...
  OPT_fweak = 915,                           /* -fweak */
  OPT_fweb = 916,                            /* -fweb */
  OPT_fwhole_file = 917,                     /* -fwhole-file */
  OPT_fwhole_program = 918,                  /* -fwhole-program */
  OPT_fwide_exec_charset_ = 919,             /* -fwide-exec-charset= */
  OPT_fworking_directory = 920,              /* -fworking-directory */
  OPT_fwpa = 921,                            /* -fwpa */
  OPT_fwrapv = 922,                          /* -fwrapv */
  /* OPT_fxref = 923, */                     /* -fxref */
  OPT_fzee = 924,                            /* -fzee */
  OPT_fzero_initialized_in_bss = 925,        /* -fzero-initialized-in-bss */
  OPT_fzero_link = 926,                      /* -fzero-link */
  OPT_g = 927,                               /* -g */
  OPT_gant = 928,                            /* -gant */
  OPT_gcoff = 929,                           /* -gcoff */
  OPT_gdwarf_ = 930,                         /* -gdwarf- */
  OPT_gen_decls = 931,                       /* -gen-decls */
  OPT_ggdb = 932,                            /* -ggdb */
  OPT_gnat = 933,                            /* -gnat */
  OPT_gnatO = 934,                           /* -gnatO */
  OPT_gno_strict_dwarf = 935,                /* -gno-strict-dwarf */
  OPT_gstabs = 936,                          /* -gstabs */
  OPT_gstabs_ = 937,                         /* -gstabs+ */
  OPT_gstrict_dwarf = 938,                   /* -gstrict-dwarf */
  OPT_gtoggle = 939,                         /* -gtoggle */
  OPT_gvms = 940,                            /* -gvms */
  OPT_gxcoff = 941,                          /* -gxcoff */
  OPT_gxcoff_ = 942,                         /* -gxcoff+ */
  OPT_h = 943,                               /* -h */
  OPT_idirafter = 944,                       /* -idirafter */
  OPT_imacros = 945,                         /* -imacros */
  ...
  OPT_mbranch_cost_ = 962,                   /* -mbranch-cost= */
  OPT_mbranch_likely = 963,                  /* -mbranch-likely */
  OPT_mcheck_zero_division = 964,            /* -mcheck-zero-division */
  OPT_mcode_readable_ = 965,                 /* -mcode-readable= */
  /* OPT_mcode_xonly = 966, */               /* -mcode-xonly */
  OPT_mcompact_eh = 967,                     /* -mcompact-eh */
  OPT_mdebug = 968,                          /* -mdebug */
  OPT_mdebugd = 969,                         /* -mdebugd */
  OPT_mdivide_breaks = 970,                  /* -mdivide-breaks */
  OPT_mdivide_traps = 971,                   /* -mdivide-traps */
  OPT_mdmx = 972,                            /* -mdmx */
  OPT_mdouble_float = 973,                   /* -mdouble-float */
  OPT_mdsp = 974,                            /* -mdsp */
  OPT_mdspr2 = 975,                          /* -mdspr2 */
  OPT_meb = 976,                             /* -meb */
  OPT_mel = 977,                             /* -mel */
  OPT_membedded_data = 978,                  /* -membedded-data */
  OPT_meva = 979,                            /* -meva */
  OPT_mexplicit_relocs = 980,                /* -mexplicit-relocs */
  OPT_mextern_sdata = 981,                   /* -mextern-sdata */
  OPT_mfix_24k = 982,                        /* -mfix-24k */
  OPT_mfix_r10000 = 983,                     /* -mfix-r10000 */
  OPT_mfix_r4000 = 984,                      /* -mfix-r4000 */
  OPT_mfix_r4400 = 985,                      /* -mfix-r4400 */
  OPT_mfix_sb1 = 986,                        /* -mfix-sb1 */
  OPT_mfix_vr4120 = 987,                     /* -mfix-vr4120 */
  OPT_mfix_vr4130 = 988,                     /* -mfix-vr4130 */
  OPT_mfix4300 = 989,                        /* -mfix4300 */
  OPT_mflip_mips16 = 990,                    /* -mflip-mips16 */
  OPT_mflush_func_ = 991,                    /* -mflush-func= */
  OPT_mfp_exceptions = 992,                  /* -mfp-exceptions */
  OPT_mfp32 = 993,                           /* -mfp32 */
  OPT_mfp64 = 994,                           /* -mfp64 */
  OPT_mframe_header_opt = 995,               /* -mframe-header-opt */
  OPT_mfused_madd = 996,                     /* -mfused-madd */
  OPT_mgp32 = 997,                           /* -mgp32 */
  OPT_mgp64 = 998,                           /* -mgp64 */
  OPT_mgpopt = 999,                          /* -mgpopt */
  OPT_mhard_float = 1000,                    /* -mhard-float */
  OPT_minterlink_mips16 = 1001,              /* -minterlink-mips16 */
  OPT_mips = 1002,                           /* -mips */
  OPT_mips16 = 1003,                         /* -mips16 */
  OPT_mips16e = 1004,                        /* -mips16e */
  OPT_mips3d = 1005,                         /* -mips3d */
  OPT_mjals = 1006,                          /* -mjals */
  OPT_mllsc = 1007,                          /* -mllsc */
  OPT_mlocal_sdata = 1008,                   /* -mlocal-sdata */
  OPT_mlong_calls = 1009,                    /* -mlong-calls */
  OPT_mlong32 = 1010,                        /* -mlong32 */
  OPT_mlong64 = 1011,                        /* -mlong64 */
  OPT_mmcount_ra_address = 1012,             /* -mmcount-ra-address */
  OPT_mmcu = 1013,                           /* -mmcu */
  OPT_mmemcpy = 1014,                        /* -mmemcpy */
  OPT_mmicromips = 1015,                     /* -mmicromips */
  OPT_mmips_tfile = 1016,                    /* -mmips-tfile */
  OPT_mmt = 1017,                            /* -mmt */
  /* OPT_mno_data_in_code = 1018, */         /* -mno-data-in-code */
  OPT_mno_float = 1019,                      /* -mno-float */
  OPT_mno_flush_func = 1020,                 /* -mno-flush-func */
  OPT_mno_mdmx = 1021,                       /* -mno-mdmx */
  OPT_mno_mips16 = 1022,                     /* -mno-mips16 */
  OPT_mno_mips3d = 1023,                     /* -mno-mips3d */
  OPT_mocteon_useun = 1024,                  /* -mocteon-useun */
  OPT_mpaired_single = 1025,                 /* -mpaired-single */
  OPT_mplt = 1026,                           /* -mplt */
  OPT_mr10k_cache_barrier_ = 1027,           /* -mr10k-cache-barrier= */
  OPT_mrelax_pic_calls = 1028,               /* -mrelax-pic-calls */
  OPT_mshared = 1029,                        /* -mshared */
  OPT_msingle_float = 1030,                  /* -msingle-float */
  OPT_msmartmips = 1031,                     /* -msmartmips */
  OPT_msoft_float = 1032,                    /* -msoft-float */
  OPT_msplit_addresses = 1033,               /* -msplit-addresses */
  OPT_msym32 = 1034,                         /* -msym32 */
  OPT_msynci = 1035,                         /* -msynci */
  OPT_mtune_ = 1036,                         /* -mtune= */
  OPT_muninit_const_in_rodata = 1037,        /* -muninit-const-in-rodata */
  OPT_mvr4130_align = 1038,                  /* -mvr4130-align */
  OPT_mxgot = 1039,                          /* -mxgot */
  OPT_n = 1040,                              /* -n */
  OPT_no_canonical_prefixes = 1041,          /* -no-canonical-prefixes */
  OPT_no_integrated_cpp = 1042,              /* -no-integrated-cpp */
  OPT_noasmopt = 1043,                       /* -noasmopt */
  OPT_nocpp = 1044,                          /* -nocpp */
  OPT_nodefaultlibs = 1045,                  /* -nodefaultlibs */
  OPT_nostartfiles = 1046,                   /* -nostartfiles */
  OPT_nostdinc = 1047,                       /* -nostdinc */
  OPT_nostdinc__ = 1048,                     /* -nostdinc++ */
  OPT_nostdlib = 1049,                       /* -nostdlib */
  OPT_o = 1050,                              /* -o */
  OPT_p = 1051,                              /* -p */
  OPT_pass_exit_codes = 1052,                /* -pass-exit-codes */
  OPT_pedantic = 1053,                       /* -pedantic */
  OPT_pedantic_errors = 1054,                /* -pedantic-errors */
  OPT_pg = 1055,                             /* -pg */
  OPT_pie = 1056,                            /* -pie */
  OPT_pipe = 1057,                           /* -pipe */
  ...
  OPT_std_f95 = 1095,                        /* -std=f95 */
  OPT_std_gnu = 1096,                        /* -std=gnu */
  ...
  OPT_std_legacy = 1108,                     /* -std=legacy */
  OPT_symbolic = 1109,                       /* -symbolic */
  OPT_t = 1110,                              /* -t */
  OPT_time = 1111,                           /* -time */
  OPT_time_ = 1112,                          /* -time= */
